...
const CATALOG = [
  ...
  { brand: 'Samsung', models: [
    'Galaxy S25', 'Galaxy S25+', 'Galaxy S25 Ultra', 'Galaxy S24', 'Galaxy S24+', 'Galaxy S24 Ultra',
    ...
    'Galaxy Note 20', 'Galaxy Note 20 Ultra', 'Galaxy Note 10', 'Galaxy Note 10+', 'Galaxy Note 9', 'Galaxy Note 8',
    ...
    'Galaxy A55', 'Galaxy A54', 'Galaxy A53', 'Galaxy A52', 'Galaxy A52s', 'Galaxy A51', 'Galaxy A50',
    'Galaxy A35', 'Galaxy A34', 'Galaxy A33', 'Galaxy A32', 'Galaxy A31', 'Galaxy A30',
    'Galaxy A25', 'Galaxy A24', 'Galaxy A23', 'Galaxy A22', 'Galaxy A21', 'Galaxy A20',
    'Galaxy A15', 'Galaxy A14', 'Galaxy A13', 'Galaxy A12', 'Galaxy A11', 'Galaxy A10', 'Galaxy A10s',
    'Galaxy A05', 'Galaxy A04', 'Galaxy A03', 'Galaxy A02', 'Galaxy A01',
    'Galaxy M55', 'Galaxy M54', 'Galaxy M53', 'Galaxy M52', 'Galaxy M51', 'Galaxy M50',
    'Galaxy M35', 'Galaxy M34', 'Galaxy M33', 'Galaxy M32', 'Galaxy M31', 'Galaxy M30',
    'Galaxy M15', 'Galaxy M14', 'Galaxy M13', 'Galaxy M12', 'Galaxy M11', 'Galaxy M10',
    'Galaxy F55', 'Galaxy F54', 'Galaxy F34', 'Galaxy F23', 'Galaxy F22', 'Galaxy F15', 'Galaxy F14', 'Galaxy F13', 'Galaxy F12',
    'Galaxy Xcover 7', 'Galaxy Xcover 6', 'Galaxy Xcover 5', 'Galaxy Xcover 4',
    'Galaxy Tab S10', 'Galaxy Tab S10+', 'Galaxy Tab S9', 'Galaxy Tab S9+', 'Galaxy Tab S9 Ultra',
    'Galaxy Tab S8', 'Galaxy Tab S8+', 'Galaxy Tab S8 Ultra', 'Galaxy Tab S7', 'Galaxy Tab S7+',
    'Galaxy Tab S6', 'Galaxy Tab S6 Lite', 'Galaxy Tab S5e', 'Galaxy Tab S4', 'Galaxy Tab S3',
    'Galaxy Tab A9', 'Galaxy Tab A9+', 'Galaxy Tab A8', 'Galaxy Tab A7', 'Galaxy Tab A7 Lite',
    'Galaxy Tab A9', 'Galaxy Tab A8', 'Galaxy Tab A7', 'Galaxy Tab A6', 'Galaxy Tab A 10.5',
    'Galaxy Tab Active4 Pro', 'Galaxy Tab Active3', 'Galaxy Tab Active2',
    'Galaxy Book4 Pro', 'Galaxy Book4', 'Galaxy Book3 Pro', 'Galaxy Book3', 'Galaxy Book2 Pro',
    'Galaxy Book', 'Galaxy Book Flex', 'Galaxy Book Ion', 'Galaxy Notebook 9',
  ]},
  ...
  { brand: 'Apple', models: [
    ...
    'iPhone SE 2020', 'iPhone SE 2022', 'iPhone SE 2016',
    'iPhone 8', 'iPhone 8 Plus', 'iPhone 7', 'iPhone 7 Plus',
    'iPhone 6s', 'iPhone 6s Plus', 'iPhone 6', 'iPhone 6 Plus',
    'iPad Pro 13"', 'iPad Pro 12.9"', 'iPad Pro 11"', 'iPad Pro 10.5"',
    ...
    'iPad 9.7"', 'iPad Pro 9.7"',
    'MacBook Air M3', 'MacBook Air M2', 'MacBook Air M1', 'MacBook Air 2020',
    'MacBook Pro 16" M3', 'MacBook Pro 14" M3', 'MacBook Pro 16" M2', 'MacBook Pro 14" M2',
    'MacBook Pro 13" M2', 'MacBook Pro 13" M1', 'MacBook Pro 2020',
    'MacBook 12"', 'MacBook 13"',
  ...
  // ── Xiaomi ──
  { brand: 'Xiaomi', models: [
    'Xiaomi 15', 'Xiaomi 15 Pro', 'Xiaomi 14', 'Xiaomi 14 Pro', 'Xiaomi 13', 'Xiaomi 13 Pro', 'Xiaomi 13T', 'Xiaomi 13T Pro',
    'Xiaomi 12', 'Xiaomi 12 Pro', 'Xiaomi 12T', 'Xiaomi 12T Pro', 'Xiaomi 12 Lite',
    'Xiaomi 11', 'Xiaomi 11 Lite 5G', 'Xiaomi 11T', 'Xiaomi 11T Pro',
    'Redmi Note 14', 'Redmi Note 14 Pro', 'Redmi Note 13', 'Redmi Note 13 Pro', 'Redmi Note 13 Pro+',
    'Redmi Note 12', 'Redmi Note 12 Pro', 'Redmi Note 12 Pro+', 'Redmi Note 12S', 'Redmi Note 12 Turbo',
    ...
    'Redmi 14C', 'Redmi 13', 'Redmi 13C', 'Redmi 12', 'Redmi 12C', 'Redmi 11', 'Redmi 11 Prime',
    'Redmi 10', 'Redmi 10C', 'Redmi 10 Power', 'Redmi 10 2022',
    'Redmi 9', 'Redmi 9A', 'Redmi 9C', 'Redmi 9T', 'Redmi 9 Power',
    'Redmi 8', 'Redmi 8A', 'Redmi 8A Dual', 'Redmi 7', 'Redmi 7A', 'Redmi 6', 'Redmi 6A',
    'POCO F6', 'POCO F6 Pro', 'POCO F5', 'POCO F5 Pro', 'POCO F4', 'POCO F4 GT', 'POCO F3', 'POCO F3 GT',
    'POCO X6', 'POCO X6 Pro', 'POCO X5', 'POCO X5 Pro', 'POCO X4', 'POCO X4 GT', 'POCO X3', 'POCO X3 NFC', 'POCO X3 Pro',
    'POCO M6 Pro', 'POCO M6', 'POCO M5', 'POCO M5s', 'POCO M4', 'POCO M4 Pro', 'POCO M4 Pro 5G', 'POCO M3', 'POCO M3 Pro',
    'POCO C65', 'POCO C55', 'POCO C51', 'POCO C50', 'POCO C40', 'POCO C31', 'POCO C3',
    'POCO Pad',
    'Redmi Pad SE', 'Redmi Pad Pro', 'Redmi Pad', 'Xiaomi Pad 6', 'Xiaomi Pad 6 Pro', 'Xiaomi Pad 6S Pro',
    'Xiaomi Pad 5',
  ]},

  // ── Motorola ──
  { brand: 'Motorola', models: [
    'Edge 50', 'Edge 50 Pro', 'Edge 50 Ultra', 'Edge 50 Fusion',
    'Edge 40', 'Edge 40 Pro', 'Edge 40 Neo', 'Edge 30', 'Edge 30 Pro', 'Edge 30 Ultra', 'Edge 30 Neo',
    'Edge 20', 'Edge 20 Pro', 'Edge 20 Lite', 'Edge+', 'Edge',
    'Razr 2024', 'Razr+ 2024', 'Razr 2023', 'Razr+ 2023', 'Razr 5G', 'Razr',
    'Moto G85', 'Moto G84', 'Moto G82', 'Moto G81', 'Moto G80', 'Moto G72', 'Moto G71', 'Moto G70',
    'Moto G54', 'Moto G53', 'Moto G52', 'Moto G51', 'Moto G50', 'Moto G42', 'Moto G41', 'Moto G40',
    'Moto G34', 'Moto G33', 'Moto G32', 'Moto G31', 'Moto G30', 'Moto G23', 'Moto G22', 'Moto G20',
    ...
    'ThinkPhone', 'Moto G53 5G', 'Moto G35',
    'Moto Tab G62', 'Moto Tab G70', 'Lenovo Tab M10',
  ]},
  ...
  { brand: 'LG', models: [
    ...
    'K62', 'K61', 'K52', 'K51', 'K50', 'K42', 'K41', 'K40', 'K31', 'K30', 'K22', 'K20', 'K12+', 'K11', 'K10', 'K9',
  ...
  { brand: 'Nokia', models: [
    ...
    'Nokia C32', 'Nokia C31', 'Nokia C30', 'Nokia C22', 'Nokia C21', 'Nokia C20', 'Nokia C12', 'Nokia C10', 'Nokia C1',
    'Nokia G60', 'Nokia G50', 'Nokia G42', 'Nokia G22', 'Nokia G21', 'Nokia G20', 'Nokia G11', 'Nokia G10',
  ...
  { brand: 'Huawei', models: [
    ...
    'Nova 12', 'Nova 12 Pro', 'Nova 12s', 'Nova 12i',
  ...
  // ── Google ──
  { brand: 'Google', models: [
    'Pixel 9', 'Pixel 9 Pro', 'Pixel 9 Pro Fold', 'Pixel 9 Pro XL',
  ...
  { brand: 'OnePlus', models: [
    ...
    'Nord 4', 'Nord 3', 'Nord CE 4', 'Nord CE 3', 'Nord CE 3 Lite', 'Nord CE 2', 'Nord CE 2 Lite',
    'Nord N30', 'Nord N20', 'Nord N10', 'Nord N100',
  ...
  { brand: 'Samsung', models: [
    'Galaxy Watch Ultra', 'Galaxy Watch 7', 'Galaxy Watch 6', 'Galaxy Watch 5', 'Galaxy Watch 4',
    'Galaxy Watch 3', 'Galaxy Watch Active 2', 'Galaxy Watch Active',
    'Galaxy Buds3 Pro', 'Galaxy Buds3', 'Galaxy Buds2 Pro', 'Galaxy Buds2', 'Galaxy Buds+', 'Galaxy Buds',
